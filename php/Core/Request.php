...
class Request implements Interfaces\Request
{
     ...
     *
     * @return  \phpUnderControlBuildMonitor\Core\Request
     */
     ...
     * @access  public
     *
     * @throws  \phpUnderControlBuildMonitor\Core\Exception
     *
     * @param   mixed   $key
     * @param   mixed   $value
     *
     ...
     * @access  public
     *
     * @param   bool    $raw        RAW output
     * @param   bool    $withHost   With scheme + host data
     *
     * @return  string
     */
    ...
    /**
     * Method returns system base href URL.
     *
     * @access  public
     *
     * @param   bool    $raw    RAW output
     ...
     * @return  string
     */
    public function getBaseHref($raw = false)
    {
        if (is_null($this->baseUrl)) {
            $this->setBaseUrl();
        }
